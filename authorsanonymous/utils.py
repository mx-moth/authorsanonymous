FONT_AWESOME_ICONS = [
    ...
    ("fa-arrow-circle-o-down", "Arrow Circle (inverted) Down"),
    ("fa-arrow-circle-o-left", "Arrow Circle (inverted) Left"),
    ("fa-arrow-circle-o-right", "Arrow Circle (inverted) Right"),
    ("fa-arrow-circle-o-up", "Arrow Circle (inverted) Up"),
    ...
    ("fa-bar-chart-o", "Bar Chart (inverted)"),
    ("fa-barcode", "Barcode"),
    ("fa-bars", "Bars"),
    ("fa-bath", "Bath"),
    ("fa-bathtub", "Bathtub"),
    ...
    ("fa-drivers-license-o", "Drivers License (inverted)"),
    ("fa-dropbox", "Dropbox"),
    ("fa-drupal", "Drupal"),
    ("fa-edge", "Edge"),
    ("fa-edit", "Edit"),
    ...
    ("fa-envelope-open", "Envelope (inverted)pen"),
    ("fa-envelope-open-o", "Envelope (inverted)pen (inverted)"),
    ...
    ("fa-facebook-official", "Facebook (inverted)fficial"),
    ...
    ("fa-firefox", "Firefox"),
    ("fa-first-order", "First (inverted)rder"),
    ("fa-flag", "Flag"),
    ...
    ("fa-folder-open", "Folder (inverted)pen"),
    ("fa-folder-open-o", "Folder (inverted)pen (inverted)"),
    ("fa-font", "Font"),
    ...
    ("fa-google-plus-official", "Google Plus (inverted)fficial"),
    ...
    ("fa-hand-grab-o", "Hand Grab (inverted)"),
    ("fa-hand-lizard-o", "Hand Lizard (inverted)"),
    ("fa-hand-o-down", "Hand (inverted) Down"),
    ("fa-hand-o-left", "Hand (inverted) Left"),
    ("fa-hand-o-right", "Hand (inverted) Right"),
    ("fa-hand-o-up", "Hand (inverted) Up"),
    ...
    ("fa-hand-stop-o", "Hand Stop (inverted)"),
    ("fa-handshake-o", "Handshake (inverted)"),
    ("fa-hard-of-hearing", "Hard (inverted)f Hearing"),
    ("fa-hashtag", "Hashtag"),
    ...
    ("fa-podcast", "Podcast"),
    ("fa-power-off", "Power (inverted)ff"),
    ("fa-print", "Print"),
    ...
    ("fa-snowflake-o", "Snowflake (inverted)"),
    ("fa-soccer-ball-o", "Soccer Ball (inverted)"),
    ("fa-sort", "Sort"),
    ...
    ("fa-stack-overflow", "Stack (inverted)verflow"),
    ("fa-star", "Star"),
    ...
    ("fa-thumbs-o-down", "Thumbs (inverted) Down"),
    ("fa-thumbs-o-up", "Thumbs (inverted) Up"),
    ...
    ("fa-toggle-off", "Toggle (inverted)ff"),
    ("fa-toggle-on", "Toggle (inverted)n"),
    ...
    ("fa-volume-off", "Volume (inverted)ff"),
